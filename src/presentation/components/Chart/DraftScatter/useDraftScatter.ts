...
export const useDraftScatter = () => {
  ...
  return useMemo(buildDraftScatter, []);
};

export type DraftScatterData = ReturnType<typeof buildDraftScatter>;

/** The same, outside React — every season must already be loaded. */
export const buildDraftScatter = () => {
