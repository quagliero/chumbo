              ...
              {playoffMatchups.map((matchup, index) => {
                ...
                return (
                  <Link
                    ...
                    className="border rounded-lg p-4 bg-white shadow-sm cursor-pointer hover:shadow-md transition-shadow block border-purple-200"
                  >
              ...
              {consolationMatchups.map((matchup, index) => {
                ...
                return (
                  <Link
                    ...
                    to={`/history/${year}/matchups/${selectedWeek}/${team1.matchup_id}`}
                    className="border rounded-lg p-4 bg-white shadow-sm cursor-pointer hover:shadow-md transition-shadow block border-gray-200 opacity-75"
                  >
                    <div className="space-y-2">
                      <div
                        className={`flex justify-between items-center p-2 rounded ${
